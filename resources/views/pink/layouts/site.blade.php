...
<head>
    ...
    <title>{{ $title ? $title : 'Pink Rio' }}</title>
    ...
    <link rel='stylesheet' href='{{ asset(config('settings.theme')) }}/css/fontawesome-all.css' type='text/css' media='all' />
    ...
    <script type="text/javascript" src="{{ asset(config('settings.theme')) }}/js/my-scripts.js"></script>
